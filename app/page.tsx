...
export default function Home() {
  return (
    <div className="py-14 px-24 max-lg:px-8 max-lg:py-8">
      <div className="flex justify-between items-end pb-16 max-lg:pb-6 pt-5 max-lg:flex-col max-lg:items-start">
      ...
      <div className="relative">
        <Image src={HeadImg} alt="picture" style={{objectFit: "cover", width: "100%"}} className="max-sm:h-44"/>
